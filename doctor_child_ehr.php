...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .vaccine-row { display:flex; gap:15px; align-items:center; flex-wrap:wrap; }
        .delay-box { margin-top:20px; padding:15px; background:#fee2e2; border-left:4px solid #dc2626; }
        
        .milestone-checkbox { width:40px; text-align:center; }
        .milestone-desc { max-width:400px; }
    </style>
</head>
<body>
<div class="wrapper">
                    ...
                    <table style="width:100%;">
                        <thead>
                            <tr>
                                ...
                                <th style="width:150px;">Date Achieved</th>
                            </tr>
                        </thead>
                        <tbody>
